    ...
    if accept == "Accepted":
        ...
        if firstname and lastname:
            ...
            if not os.path.exists(filepath):
                ...
                heading = ["First Name", "Last Name", "Title", "Age", "Continent",
                           "Courses", "Semester", "Registration status"]
            ...
            sheet = workbook.active
            sheet.append([firstname, lastname, title, age, continent, 
                          numcourse, numsemester, registered_status])
            workbook.save(filepath)
